...
if fig1_plot == "柱状图":
    ...
    if fig1_hv:
        fig2 = px.box(bill_fig2_basic, x="金额", y=fig1_for0, points=fig1_points, orientation='h')
    else:
        fig2 = px.box(bill_fig2_basic, x=fig1_for0, y='金额', points=fig1_points, orientation='v')
    fig2.update_layout(template="ggplot2")
elif fig1_plot == "小提琴图":
    if fig1_hv:
        fig2 = px.violin(bill_fig2_basic, x='金额', y=fig1_for0, points=fig1_points, orientation='h')
    else:
        fig2 = px.violin(bill_fig2_basic, x=fig1_for0, y='金额', points=fig1_points, orientation='v')
    fig2.update_layout(template="ggplot2")
